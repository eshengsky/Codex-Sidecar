export const messages = {
  en: {
    ...
    explorations: {
      ...
      emptyDescription: 'Run multiple read-only Codex answers for the same question, then merge and compare the result.',
    ...
    prompts: {
      ...
      emptyDescription: 'Save reusable, temporary instruction text to copy into Codex. Put long-term rules in AGENTS.md and fixed workflows in skills.',
  ...
  zh: {
    ...
    explorations: {
      ...
      countLabel: 'x{count}',
      emptyTitle: '还没有优选记录',
      emptyDescription: '让多个只读 Codex 独立回答同一问题，再汇总对比生成结果。适合方案判断和复杂问题。',
    ...
    prompts: {
      ...
      add: '新增指令',
      emptyTitle: '还没有指令',
      emptyDescription: '保存常用、临时、需要复制到 Codex 的指令文本。长期规则放 AGENTS.md，固定流程做成 skill。',
