export const messages = {
  en: {
    ...
    threads: {
      ...
      contextUsageTooltip: 'Used {percent}% · {totalTokens} / {modelContextWindow} tokens'
    },
    bookmarks: {
      ...
      emptyMessagesDescription: 'Favorite Q&A turns from message index will appear here.',
    ...
    explorations: {
      ...
      emptyDescription: 'Use selections to run multiple read-only Codex candidates in parallel, then merge them into a result.',
      emptySearchTitle: 'No matching selections',
      emptySearchDescription: 'Try another keyword, or start a new selection.',
      openResult: 'Open result',
      deleteRecord: 'Delete selection record',
      deleteConfirmTitle: 'Delete selection record',
    ...
    prompts: {
      ...
      emptyDescription: 'Use instructions to save temporary or frequently used prompts, then copy them into Codex with one click.',
      emptySearchTitle: 'No matching instructions',
      emptySearchDescription: 'Try another keyword, or add an instruction.',
    ...
    settings: {
      ...
      miniOverDock: 'Show mini tool above Dock',
      showMiniPrompts: 'Show instruction button in mini tool',
      data: 'Data backup',
      version: 'Version',
      upToDate: 'Up to date',
      updating: 'Updating...',
  ...
  zh: {
    ...
    threads: {
      ...
      contextUsageTooltip: '已用 {percent}% · {totalTokens} / {modelContextWindow} tokens'
    },
    bookmarks: {
      typeLabel: '收藏类型',
      conversations: '对话',
      ...
      emptyMessagesDescription: '在消息索引中收藏的一轮问答会出现在这里。',
      add: '添加收藏',
      remove: '取消收藏',
      addTurn: '收藏',
      removeTurn: '取消收藏'
    ...
    explorations: {
      ...
      countLabel: 'x{count}',
      emptyTitle: '还没有优选',
      emptyDescription: '优选用于并行生成多个只读候选，再汇总成结果。适合方案判断和复杂问题。',
      emptySearchTitle: '没有匹配的优选',
      emptySearchDescription: '换个关键词试试，或新建一次优选。',
      openResult: '打开结果',
      deleteRecord: '删除优选记录',
      deleteConfirmTitle: '删除优选记录',
    ...
    prompts: {
      ...
      add: '新增指令',
      emptyTitle: '还没有指令',
      emptyDescription: '指令用于保存临时或常用提示，一键复制到 Codex 使用。',
      emptySearchTitle: '没有匹配的指令',
      emptySearchDescription: '换个关键词试试，或新增一条指令。',
      editTitle: '编辑指令',
      newTitle: '新增指令',
      tipsTitle: '使用建议',
    ...
    settings: {
      ...
      miniOverDock: 'mini 工具显示在 Dock 上方',
      showMiniPrompts: 'mini 工具显示指令按钮',
      data: '数据备份',
      version: '版本',
      upToDate: '已是最新',
      updating: '正在更新...',
